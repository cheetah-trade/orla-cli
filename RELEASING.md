...
`.claude-plugin/` turns this repository into a plugin marketplace, and the
skills in `skills/` ship from the same tag as the package. Two things keep that
...
gate is what says the copy is due.
